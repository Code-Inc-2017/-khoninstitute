...
$conn=mysqli_connect(global_mysql_server, global_mysql_user, global_mysql_password,global_mysql_database)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
//ysqli_select_db($conn,global_mysql_database)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
